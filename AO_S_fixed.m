function [S_new, swap_flag] = AO_S_fixed(params, scene, model, state)
% AO_S_fixed：固定天线构型下，按 restricted single-swap 更新用户集 S
...
for iter_swap = 1:max_swaps
    ...
    J_strong = build_external_strong_set_fixed(params, scene, state_now, S_new);
